...
public class MapsActivity extends FragmentActivity implements
    ...
    public void onClick(View v){
        String hospital = "hospital", school = "school", restaurants = "restaurants";
                    ...
                    try {
                        ...
                        if(addressList != null){
                            for (int i=0; i<addressList.size(); i++){
                                ...
                                LatLng latLng = new LatLng(userAddress.getLatitude(),userAddress.getLatitude());
    ...
    private  String  getUrl(double latitude,double longitude,String nearbyPlace){
        ...
        googleURL.append("&key=" + "AIzaSyAWQONZZAkx36mumHKLgCsLYQwpcL5pWx4");
